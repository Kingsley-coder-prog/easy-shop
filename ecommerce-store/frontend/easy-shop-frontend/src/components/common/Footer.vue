  ...
  <footer class="bg-gray-900 text-white mt-16">
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        <!-- About Section -->
        <div>
          <h3 class="font-bold text-lg mb-4">ABOUT EASY SHOP</h3>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-300 text-sm">
            ...
            <li>
              <a href="#" class="hover:text-white transition">How to Shop</a>
            </li>
            <li>
              <a href="#" class="hover:text-white transition"
                >Track Your Order</a
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-300 text-sm">
            ...
            <li>
              <a href="#" class="hover:text-white transition">Order History</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" class="hover:text-white transition">Site Map</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="text-gray-300 text-sm">
            <p class="mb-2">Email: support@easyshop.com</p>
      ...
      <!-- Copyright -->
      <div
        class="border-t border-gray-800 pt-6 text-center text-gray-400 text-sm"
      >
        <p>&copy; {{ currentYear }} Easy Shop. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
